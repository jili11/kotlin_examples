...
import taxipark.taxipark.display
import taxipark.taxipark.driver
import taxipark.taxipark.taxiPark
import taxipark.taxipark.trip
...
class TestTask1FakeDrivers {
    ...
    @Test
    fun test1() = testFakeDrivers(setOf(2, 3),
        taxiPark(
            1..3,
            1..2,
            trip(1, 1),
    ...
    @Test
    fun test2() = testFakeDrivers(setOf(3), taxiPark(
        0..3, 0..9,
    ...
    @Test
    fun test3() = testFakeDrivers(setOf(0, 2, 4), taxiPark(
        0..4, 0..9,
    ...
    @Test
    fun test4() = testFakeDrivers(setOf(0, 1, 4, 5, 8), taxiPark(
        0..9, 0..19,
    ...
    @Test
    fun test5() = testFakeDrivers(setOf(2, 7, 8, 11, 14, 15, 16, 18), taxiPark(
        0..19, 0..19,
    ...
    @Test
    fun test6() = testFakeDrivers(setOf(5, 7), taxiPark(
        0..9, 0..19,
